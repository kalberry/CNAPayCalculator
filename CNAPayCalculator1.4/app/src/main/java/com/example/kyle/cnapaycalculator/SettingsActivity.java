...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        morningPaySetting.setText(Float.toString(sharedPreferences.getFloat("morning", HoursCalculatorActivity.MORNING_DEFAULT_RATE)));
        eveningPaySetting.setText(Float.toString(sharedPreferences.getFloat("evening", HoursCalculatorActivity.EVENING_DEFAULT_RATE)));
        overnightPaySetting.setText(Float.toString(sharedPreferences.getFloat("overnight", HoursCalculatorActivity.OVERNIGHT_DEFAULT_RATE)));
